...
export default class header extends React.Component {
    memberHandler = () => {
        window.location.href = "http://localhost:3000/#/member-portal";
   }

    render() {
      return (
          <div className="header">
              <a href = "http://localhost:3000/"><img src={logo} style={{height:55, width: 90, position:"absolute", left:50, top:15}}/></a>
