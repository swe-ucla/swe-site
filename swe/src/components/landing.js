      ...
      return (
        <div >
			...
			<div class="flex-container" style={{paddingTop:30}}>
				<div class="flex-child-left" style={{minWidth:500, paddingTop:30}}>
					<img className="front_image" style={{width: 600, height: 400}} src={frontimage}/>
				</div>
			...
			<div class="flex-container" >
                    ...
                    <div class="flex-child-left" style={{minWidth:400}}>
						...
						<div class="flex-child-left" style={{minWidth:400, flex:1, paddingLeft:100}}>
							...
							/>*/}
                            <a href = "https://tinyurl.com/sweucla-subscribe" className="pic_buttons">Join Our Mailing List</a>
						</div>
